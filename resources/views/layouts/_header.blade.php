                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                            <span class="user-avatar pull-left" style="margin-right:8px;margin-top:-5px;">
                                {{--  <img src="https://fsdhubcdn.phphub.org/uploads/images/201709/20/1/PtDKbASVcz.png?imageView2/1/w/60/h/60/" class="img-responsive img-circle" width="30px">  --}}
                                <img src="{{Auth::user()->avatar}}" class="img-responsive img-circle" style="width:30px;height:30px">                                
                            </span>
                            {{Auth::user()->name}}
